...
parser = argparse.ArgumentParser(description='Visualize molecule embeddings using t-SNE')
parser.add_argument('--chem_emb_dir', type=str, required=True, help='Directory containing the molecule embeddings')
...
chem_embeddings_train = np.load(os.path.join(args.chem_emb_dir, 'chem_embeddings_train.npy'))
cids_train = np.load(os.path.join(args.cid_emb_dir, 'cids_train.npy'))


# Load the chemical embeddings and CIDs
#chem_embeddings_train = np.load('/Users/sherry/Downloads/598dhl/Model_embeddings/2024_4_8_epoch40_sample100_mlp1/chem_embeddings_train.npy')
...
ax.set_title('t-SNE Visualization of Top 100 Chemical Embeddings')
